...
PUBLIC _prSUB ;процедура prADD - общедоступна€
.code ;сегмент кода
_prSUB PROC ;заголовок процедуры prADD
...
SUB AX, SWORD PTR [EBP+10] ;2-й параметр B - по адресу [EBP+10]
POP EBP ;восстановление регистра EBP
RET 4 ;точка выхода, удал€ем 4 байта
_prSUB ENDP ;ENDP Ц окончание описани€ prADD
